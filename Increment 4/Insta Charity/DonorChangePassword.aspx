<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DonorChangePassword.aspx.cs" Inherits="DonorChangePassword" %>
...
<div data-role= "content">
       ...
       <label for = "NewPassword"> New Password</label>:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:TextBox ID="txtNewPassword" TextMode="Password" 
       ...
       <td colspan="2">
            <br />
        <br />
            <a href= "mainpage.aspx" runat="server"> Go to Home
            </a><asp:ValidationSummary ID="ValidationSummary1" 
